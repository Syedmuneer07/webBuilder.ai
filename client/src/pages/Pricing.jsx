...
try {
    ...
    const { data } = await axios.post(`${serverUrl}/api/billing`, { planType: planKey }, { withCredentials: true })
    ...
    const options = {
        ...
        name: "Your App",
        description: `Genweb.ai ${planKey.toUpperCase()} plan`,
        order_id: data.order.id,
        handler: async function (response) {
            try {
                await axios.post(`${serverUrl}/api/verify-payment`, {
        ...
        prefill: userData?.email ? { email: userData.email } : undefined,
        theme: { color: "#6366f1" },
    };
            ...
            <div className='relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
              ...
              ${p.popular
                    ...
                    >
                        ...
                        >
                            {loading===p.key?"Opening checkout...":p.button}
